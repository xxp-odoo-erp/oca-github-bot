...
RUN set -x \
  && /ocamt/bin/pip install --no-cache-dir -e git+https://github.com/xxp-odoo-erp/xxp-maintainer-tools@f70373fca6830e6536c3967ba5794311602b4bd4#egg=oca-maintainers-tools \
